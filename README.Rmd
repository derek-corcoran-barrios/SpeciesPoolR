...
Here we see the first 9 observations of the dataset in table \@ref(tab:tablespeciespred), where we see the spacial suitability of each species on each landuse
