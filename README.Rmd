...
7.  Generates a threshold for each species based on presences and the models that where build.

8.  Build a lookup table for each species with the suitable habitats.

9. Lastly it generates a potential presences files from the look-up table, buffered presences, and the potential habitat table.
