...
12. **Calculate rarity weights** Calculates a Rarity weight for the counts of species that have more than zero presences.

12. **Generates a phylogenetic tree** for the species in the species list, using the `generate_tree` function.

13. **Generates a visual representation** of the workflow if `plot = TRUE`.
