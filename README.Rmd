...
# SpeciesPoolR<a href="https://derek-corcoran-barrios.github.io/SpeciesPoolR/"><img src="man/figures/logo.png" align="right" height="120" alt="SpeciesPoolR website" /></a>
<!-- badges: start -->
...
#### Maximum Entropy Model for Land Use Selection
...
```{r dirResults, echo=FALSE}
library(fs)
fs::dir_tree("Results", recursive = T)
```
...
unlink("Field_Final_Presences/", recursive = T, force = T)
unlink("Results/", recursive = T, force = T)
```
